...
export const articles: Article[] = [
...

  {
    ...
    sections: [
      ...
      { heading: "The Pattern", content: "Notice what all of these have in common: no patient data, no clinical content, and lower compliance risk than patient-specific workflows. They are all operational and leadership tasks. This is the safest and fastest way to start getting value from AI. Once your team sees you using it effectively, they will start asking questions — and that is when you can introduce it more broadly with proper training and policies." },
    ]
  },
  {
